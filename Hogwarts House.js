...
const SKILL_NAME = "Hogwarts House Quiz";
...
const HELP_REPROMPT = "Your Hogwarts House will be revealed after you answer all my yes or no questions.";
const STOP_MESSAGE = "Your Hogwarts House will be waiting for you next time.";
const MISUNDERSTOOD_INSTRUCTIONS_ANSWER = "Please answer with either yes or no.";
const HINT_TEXT = `To play again, just say "Alexa, open ${Hogwarts House Quiz}"`
...
const WELCOME_MESSAGE = "Hi! I can tell you which Hogwarts House you belong in. All you have to do is answer five questions with either yes or no. Are you ready to start?";
...
const resultList = {
  result1: {
    ...
    audio_message: "You belong in Gryffindor.",
  ...
  result2: {
    name: "Hufflepuff",
    display_name: "Hufflepuff",
    audio_message: "You belong in Hufflepuff.",
    description: "You belong in Hufflepuff. Where they are just and loyal. Those patient Hufflepuffs are true and unafraid of foil.",
    img: {
  ...
  result3: {
    ...
    audio_message: "You belong in Ravenclaw. ",
    description: "You belong in Ravenclaw. Where those of will and learning will always find their kind.",
    img: {
  ...
  result4: {
    ...
    audio_message: "You belong in Slytherin. ",
